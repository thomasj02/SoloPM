...
INSTRUCTIONS = (
    ...
    "ticket to 'done'. Never push branches or open/merge PRs yourself with `gh`: a ticket "
    "whose branch was never recorded cannot be auto-merged and leaves the human cleaning "
    "up by hand.\n\n"
